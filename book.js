const book={
    bookData:[
    {'id_book' :1, 'name' :"Everything You Ever Wanter to Know", 'author' :"Upton", 'isbn' :"082305649x"},
    ...
    addBook: function(addId, addName, addAuth, addIsbn){
        this.bookData.push({id_book:addId, name:addName, author:addAuth, isbn:addIsbn});
    }
};

//book.getAllBooks();
//book.getOneBook(1);
book.addBook(16,'Kirja','Kirjailija','isbn-sarja');
book.getOneBook(15);